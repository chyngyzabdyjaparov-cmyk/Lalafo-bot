...
def fetch_category_html():
    try:
        ...
        # как это делает обычный браузер — иногда это помогает пройти защиту от ботов
        _session.get("https://lalafo.kg/", timeout=20)
        r = _session.get(CATEGORY_URL, timeout=20)
